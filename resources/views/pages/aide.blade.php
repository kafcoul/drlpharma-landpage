    ...
    <section class="content">
        <div class="container">
            ...
            <div class="search-box">
                ...
                <input type="text" id="search" placeholder="Rechercher une question…"
            ...
            <div class="faq-section" data-section>
                ...
                <div class="faq-item" data-faq>
                    <button class="faq-q" onclick="toggleFaq(this)">Comment passer une commande ? <svg
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg></button>
                    <div class="faq-a">Téléchargez l'application DR-PHARMA Patient, créez un compte puis recherchez
                        votre médicament par nom ou envoyez une photo de votre ordonnance. Ajoutez au panier, choisissez
                        votre mode de paiement et validez.</div>
                </div>
                <div class="faq-item" data-faq>
                    ...
                    <div class="faq-a">En moyenne, votre commande est livrée en moins de 45 minutes dans les zones
                        couvertes d'Abidjan. Le temps peut varier selon la distance et la disponibilité des coursiers.
                    </div>
                </div>
                <div class="faq-item" data-faq>
                    <button class="faq-q" onclick="toggleFaq(this)">Comment suivre ma livraison ? <svg
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg></button>
                    <div class="faq-a">Une fois votre commande confirmée, vous pouvez suivre votre coursier en temps
                        réel sur la carte directement dans l'application.</div>
                </div>
                <div class="faq-item" data-faq>
                    <button class="faq-q" onclick="toggleFaq(this)">Puis-je annuler une commande ? <svg
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg></button>
                    <div class="faq-a">Oui, tant que la pharmacie n'a pas encore préparé votre commande. Rendez-vous
                        dans "Mes commandes" et appuyez sur "Annuler".</div>
                </div>
            </div>
            ...
            <div class="faq-section" data-section>
                ...
                <div class="faq-item" data-faq>
                    ...
                    <div class="faq-a">Vérifiez que votre solde est suffisant et que vous avez une bonne connexion
                        internet. Si le problème persiste, essayez un autre moyen de paiement ou contactez notre
                        support.</div>
                </div>
                <div class="faq-item" data-faq>
                    ...
                    <div class="faq-a">En cas de problème avec votre commande, contactez notre support. Les
                        remboursements sont traités sous 24 à 48 heures sur votre moyen de paiement d'origine.</div>
                </div>
            </div>
            ...
            <div class="faq-section" data-section>
                ...
                <div class="faq-item" data-faq>
                    <button class="faq-q" onclick="toggleFaq(this)">Comment créer un compte ? <svg
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg></button>
                    <div class="faq-a">Téléchargez l'application, appuyez sur "S'inscrire" et suivez les étapes. Vous
                        aurez besoin d'un numéro de téléphone valide pour la vérification par OTP.</div>
                </div>
                <div class="faq-item" data-faq>
                    <button class="faq-q" onclick="toggleFaq(this)">J'ai oublié mon mot de passe, comment le
                        réinitialiser ? <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                        </svg></button>
                ...
                <div class="faq-item" data-faq>
                    ...
                    <div class="faq-a">Oui. Toutes les communications sont chiffrées (HTTPS/TLS). Vos données
                        personnelles et médicales sont protégées conformément à notre politique de confidentialité.
                    </div>
                </div>
            </div>
            ...
            <div class="faq-section" data-section>
                ...
                <div class="faq-item" data-faq>
                    ...
                    <div class="faq-a">Contactez-nous via le formulaire de contact ou par email. Un membre de notre
                        équipe vous accompagnera dans l'inscription et la configuration de votre officine sur la
                        plateforme.</div>
                </div>
                <div class="faq-item" data-faq>
                    ...
                    <div class="faq-a">Téléchargez l'application DR-PHARMA Coursier et complétez votre inscription
                        avec vos documents (CNI, permis). Votre candidature sera examinée sous 48h.</div>
                </div>
            </div>
